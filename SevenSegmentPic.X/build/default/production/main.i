...
# 52 "C:\Program Files (x86)\Microchip\xc8\v2.10\pic\include\pic16f886.h"
...
# 167
asm("\tpsect eeprom_data,class=EEDATA,delta=2,space=3,noexec"); asm("\tdb\t" "255" "," "0b01111110" "," "0b00110000" "," "0b01101101" "," "0b01111001" "," "0b00110011" "," "0b01011011" "," "0b01011111");
asm("\tpsect eeprom_data,class=EEDATA,delta=2,space=3,noexec"); asm("\tdb\t" "0b01110000" "," "0b01111111" "," "0b01110011" "," "255" "," "255" "," "255" "," "255" "," "255");


void display( short num) {
PORTB = eeprom_read(num + 1);
}
...
ANS13, ANS11, ANS9, ANS8, ANS10, ANS12 = 0;
TRISB &= 10000000;
PORTB = 0;

TRISA &= 11110000;
ANS0, ANS1, ANS2, ANS3 = 0;
PORTA = 0;
